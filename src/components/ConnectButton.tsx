...
export default function ConnectButton() {
  ...
  return (
    <button
      onClick={connect}
      className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium transition-colors shadow-lg shadow-indigo-900/20 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-slate-950"
    >
      <Wallet className="w-4 h-4" aria-hidden="true" />
